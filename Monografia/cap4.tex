...
Devido à pouca quantidade de padrões para treinamento para o cliente 2, é possível observar na Tabela \ref{Cliente2_Apt} que o filme \emph{Apt Pupil}, com baixa avaliação, relaciona-se com outros que foram bem aprovados pelo cliente.

\begin{table}[htbp]
	\centering
	\caption{Resultados para o cliente 2 e o filme \emph{Apt Pupil}}
		\begin{tabular}{|p{3.1cm}|p{3cm}|c|c|c|}
		  \hline
			\textbf{Título} & \textbf{Gênero} & \textbf{Ano} & \textbf{Número de locações} & \textbf{Avaliação} \\
			\hline
