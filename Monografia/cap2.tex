...
\begin{figure}[htbp]
	...
	\caption{Avaliações de usuários no site da Amazon para uma câmera fotográfica.}
	\label{avaliacao}
\end{figure}
...
\begin{figure}[htbp]
	...
	\caption{Recomendações da Amazon de acordo com o histórico do cliente.}
...
\begin{figure}[htbp]
	...
	\caption{Associação de produtos por clientes no site da Amazon}
	\label{also_bought}
\end{figure}
