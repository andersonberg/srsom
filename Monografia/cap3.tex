...
Este trabalho visa apresentar um modelo para recomendação de filmes para clientes no ambiente de vídeo locadoras. O modelo proposto utiliza as redes SOM como descritas por Kohonen \cite{Kohonen1989} para aprender o perfil do usuário e auxiliá-lo na escolha do filme.

Após a descrição dos conceitos e algoritmos apresentados no capítulo 2, será apresentada neste capítulo a contribuição do modelo proposto.
