...
Inicialmente estava sendo negociada a obtenção dos dados de uma vídeo locadora da cidade, mas devido a entraves na política de segurança da empresa que fornece o sistema para esta locadora, não foi possível coletar os dados reais para teste de campo do sistema. A alternativa encaminhada foi utilizar uma base, também real, disponível abertamente na internet. A base de dados utilizada foi a \emph{MovieLens Data Set} (http://www.grouplens.org), fornecida pelo grupo de pesquisa GroupLens Research. Essa base conta com 100.000 avaliações para 1682 filmes por 943 usuários. A base MovieLens foi construída a partir do sítio de recomendações de filmes: movielens.org. A base de dados MovieLens é assim organizada: 
