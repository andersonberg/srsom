...
\begin{itemize}
	...
	\item ''Clientes que adquiriram um produto X, também compraram Y'': O sistema de recomendação cria associações entre produtos avaliados pelo usuário para oferecer produtos relacionados ao que o cliente está adquirindo no momento (Figura \ref{also_bought}).
